...
\lstdefinelanguage{HTML5}{
  ...
  <speakur-discussion, </speakur-discussion, <twbs-navbar, </twbs-navbar, <firebase-element, </firebase-element
  },
  ndkeywords={
  % General
  =,
  ...
  firebaseLocation=, xtitle=, initiallyOpen=, allowAnonymous=, location=, data=, on-click=,
  % SVG attributes
