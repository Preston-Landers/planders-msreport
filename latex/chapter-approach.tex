...
From a technical perspective, one of the more interesting features in Speakur is the use of Polymer's\index{Polymer} data-bound templates\index{data-bound template}, also known as Model-Driven Views\index{Model-Driven View}, 
...
Data binding\index{data-bound template|textbf} is one of the most important extensions to standard DOM that is provided by the Polymer\index{Polymer} framework. 
