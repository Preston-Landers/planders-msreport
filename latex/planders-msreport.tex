...
Web Components are a proposed HTML5 standard for writing custom HTML tags that take advantage of new browser technologies like Shadow DOM, CSS Flexbox and data-bound templates.
This report will review these new Web Component technologies and provide a case study of structuring a real-world WC applet that is embedded in a larger page or app.
...
Subsidiary questions include assessing the maturity and suitability of current Web Components technologies for widespread deployment and how to efficiently synchronize component state across a distributed network.
