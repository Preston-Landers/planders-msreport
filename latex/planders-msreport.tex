...
% urlcolor=black,
%% pdffitwindow=true,
% pdftitle={Selmy: an adaptive API for cloud database services},
...
% Required
\title{Selmy: an adaptive API for cloud database services}
...
was born in Arlington, Texas and attended high school in Incline Village, Nevada. 
...
in Austin, Texas and began graduate studies at 
