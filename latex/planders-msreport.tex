...
%\usepackage[driver=pdftex,margin=1.2in,letterpaper]{geometry} % Required to change the page size to A4
%\usepackage[driver=xetex,margin=1.2in,letterpaper]{geometry} % Required to change the page size to A4
...
\address{3300 Bratton Ridge Crossing\\ Austin, Texas 78728}  % Required
