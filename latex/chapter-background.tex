...
similar to an \tcode{\#include}\index{\tcode{\#include}} directive in the C language\index{C language} or the packaging and import systems popular in scripting languages\index{scripting languages}
