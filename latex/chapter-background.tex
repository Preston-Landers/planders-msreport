...
\tcode{<span>}~\cite{w3ccontributors2015-b}.
...
Unlike the rest of Web Components, \tcode{<template>} has already become a standard part of the HTML5 specification~\cite{w3ccontributors2015-c}, 
although one that is perhaps not widely used yet outside of WC.
