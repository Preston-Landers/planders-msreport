...
This allows embedding variables directly in the HTML representation of a component as shown in Listing~\ref{l:dbtemplate} and here:
...
and a `production' or Vulcanized version where all necessary resources are combined into a single file for faster loading speeds~\cite{polymercontributors2015-a}. 
...
\midrule
\textit{Google Chrome}\index{Google!Google Chrome} \\ 
visible & 2200 & 1150 \\
complete & 4200 & 2900 \\
\\
\textit{Mozilla Firefox}\index{Mozilla!Mozilla Firefox}\index{Firefox} \\ 
visible & 7400 & 6050 \\
complete & 12000 & 10500 \\
\\
\textit{Opera}\index{Opera} \\ 
visible & 2800 & 1100 \\
complete & 7000 & 2800 \\
\bottomrule
\end{tabular}
